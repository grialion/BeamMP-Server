...
RUN --mount=type=cache,target=/src/bin/vcpkg_installed bash ./scripts/debian-12/2-configure.sh
RUN --mount=type=cache,target=/src/bin/vcpkg_installed bash ./scripts/debian-12/3-build.sh
